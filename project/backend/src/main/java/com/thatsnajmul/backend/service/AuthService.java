...
import com.thatsnajmul.backend.entity.Role;
import com.thatsnajmul.backend.entity.Token;
import com.thatsnajmul.backend.entity.User;
import com.thatsnajmul.backend.jwt.JwtService;
import com.thatsnajmul.backend.repository.TokenRepository;
import com.thatsnajmul.backend.repository.UserRepository;
...
public class AuthService {
    ...
    public AuthenticationResponse registerHotel(User user) {
        ...
        user.setPassword(passwordEncoder.encode(user.getPassword()));
        user.setRole(Role.valueOf("EDITOR"));
        user.setLock(false);
        user.setActive(false);
